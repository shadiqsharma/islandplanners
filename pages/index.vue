  ...
  <div class="wrapper landing-page">
    <div class="page-header page-header-small rellax-header">
      <div class="page-header-image"
           style="background-image: url('img/bghome.jpeg')">
      </div>
<!--social media button-->
      <div class="content-center">
        <h1 class="title">Welcome to Langkawi Art Budget Rooms!</h1>
        ...
        <div class="section-story-overview">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="image-container image-left" style="background-image: url('img/bghome2.png')">
              ...
              <div class="image-container image-left-bottom"
                   style="background-image: url('img/bghome3.png')"></div>
            </div>
            <div class="col-md-5">
